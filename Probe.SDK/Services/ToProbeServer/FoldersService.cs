...
namespace Aiursoft.Probe.SDK.Services.ToProbeServer
{
    public class FoldersService : IScopedDependency
    {
        ...
        {
            var url = new AiurUrl(_serviceLocation.Endpoint, $"/Folders/ViewContent/{siteName.ToUrlEncoded()}/{folderNames.EncodePath()}", new ViewContentAddressModel
            {
        ...
        {
            var url = new AiurUrl(_serviceLocation.Endpoint, $"/Folders/DeleteFolder/{siteName.ToUrlEncoded()}/{folderNames.EncodePath()}", new { });
