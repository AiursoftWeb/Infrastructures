...
namespace Aiursoft.WebTools.Tests.Services
{
    ...
    public class QRCodeSericeTests
    {
        ...
        {
            var myCode = _qrCodeService.ToQRCodeBase64("https://github.com/AiursoftWeb/Infrastructures/blob/dev/src/WebServices/Infrastructure/Warpgate/Migrations/20200617163030_AddEnabled.Designer.cs");
            Assert.IsTrue(myCode.Length > 5000, "Generated qrcode is too short.");
