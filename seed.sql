...
values('{{developerAppId}}','{{developerAppSecret}}','Aiursoft Developer Center','2020-01-01 12:34:56','aiursoft-app-icons/appdefaulticon.png','Aiursoft Developer Center',0,7,1,0,0,0,'developer.{{domain}}',1,'{{userId}}',0,0,0,1,1);
insert into Apps(AppId,AppSecret,AppName,AppCreateTime,IconPath,AppDescription,AppCategory,AppPlatform,EnableOAuth,ForceConfirmation,ForceInputPassword,DebugMode,[AppDomain],ViewOpenId,CreatorId,ViewPhoneNumber,ChangePhoneNumber,ConfirmEmail,ChangeBasicInfo,ChangePassword)
values('{{gatewayAppId}}','{{gatewayAppSecret}}','Aiursoft Gateway','2020-01-01 12:34:56','aiursoft-app-icons/appdefaulticon.png','Aiursoft Gateway',0,7,1,0,0,0,'gateway.{{domain}}',1,'{{userId}}',0,0,0,1,1);
insert into Apps(AppId,AppSecret,AppName,AppCreateTime,IconPath,AppDescription,AppCategory,AppPlatform,EnableOAuth,ForceConfirmation,ForceInputPassword,DebugMode,[AppDomain],ViewOpenId,CreatorId,ViewPhoneNumber,ChangePhoneNumber,ConfirmEmail,ChangeBasicInfo,ChangePassword)
values('{{stargateAppId}}','{{stargateAppSecret}}','Aiursoft Stargate','2020-01-01 12:34:56','aiursoft-app-icons/appdefaulticon.png','Aiursoft Stargate',0,7,1,0,0,0,'stargate.{{domain}}',1,'{{userId}}',0,0,0,1,1);
